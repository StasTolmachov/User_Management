...
func (_m *MockCacheRepository) Close() error {
	ret := _m.Called()
...
func (_c *MockCacheRepository_Close_Call) Return(_a0 error) *MockCacheRepository_Close_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_m *MockCacheRepository) Del(ctx context.Context, key string) error {
...
func (_c *MockCacheRepository_Del_Call) Return(_a0 error) *MockCacheRepository_Del_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockCacheRepository_Del_Call) RunAndReturn(run func(context.Context, string) error) *MockCacheRepository_Del_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockCacheRepository) Set(ctx context.Context, key string, value interface{}) error {
...
//   - key string
//   - value interface{}
func (_e *MockCacheRepository_Expecter) Set(ctx interface{}, key interface{}, value interface{}) *MockCacheRepository_Set_Call {
	return &MockCacheRepository_Set_Call{Call: _e.mock.On("Set", ctx, key, value)}
}

func (_c *MockCacheRepository_Set_Call) Run(run func(ctx context.Context, key string, value interface{})) *MockCacheRepository_Set_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockCacheRepository_Set_Call) RunAndReturn(run func(context.Context, string, interface{}) error) *MockCacheRepository_Set_Call {
	_c.Call.Return(run)
	return _c
}
